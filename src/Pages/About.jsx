...
import Rohit2 from '../assets/Profile_new2.jpg';
...
export default function About() {
 ...
 useEffect(() => {
  ...
  return (
    <>
    <div class="about_section"  data-AOS="fade" data-AOS-delay="300" className='pb-65 lg:pb-25 pt-3 gap-2 isolate  grid-cols-2 flex  overflow-hidden'  >
    ...
    <div >
      <h1  data-AOS="fade-up" className='  -mb-5 text-2xl lg:text-6xl font-bold tracking-widest bg-gradient-to-br from-purple-500  to-blue-500 bg-clip-text text-transparent' style={{ filter: 'drop-shadow(0 5px 30px rgba(147, 51, 234, 1))' }}>ROHIT  BENDRE</h1>
    </div>
   ...
   <br></br>
     I am a BCA-TY student From SRTMU Nanded, i just love Programming, always Excited to learn new technologies and build something Beautiful and Useful. Now in search of a Role as SDE-1 in software companies. im searching for both 'Product Based' and 'Service Based' companies.
      ...
      <h1  data-AOS="fade-up" className='text-2xl font-bold w-80 text-left my-2 lg:my-6 lg:text-5xl lg:w-1500 tracking-wider' style={{ filter: 'drop-shadow(0 5px 30px rgba(147, 51, 234, 1))' }}>WAY TO SOFTWARE ENGINEER.</h1>
      <p  data-AOS="fade-up" className='text-sm  text-neutral-300'>
...
<img src={bg} className="absolute w-full h-6/7 my-20 lg:my-20 "></img>
   ...
   >
     ...
     <div  data-AOS="fade-up" className='-ml-17  w-6/8 lg:w-6/12  lg:ml-10 text-center text-sm'>
      ...
      <p  style={{fontSize:"14px",color:"lightGrey"} } >-Strong  knowledge of different programming languages, Basics Are strong in Programming, Concepts are very clear about Object Oriented Programming languages, Working on real world projects.
        <br/> <br/>
        ...
        <br/> <br/>
        - Enough Knowledge of Git , Github , Render.com And other Professional Tools related to programming.
        <br/> <br/>
