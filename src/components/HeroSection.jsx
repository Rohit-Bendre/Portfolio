  ...
  useEffect(() => {
    ...
    return (
        <div className=' mb-30 flex flex-col items-center mt-15 lg:mt-20'>
            <h1 className='font-bold text-4xl sm:text-6xl lg:text-7xl text-center tracking-wider lg:mb-4  ' data-AOS="fade"  style={{ filter: 'drop-shadow(0 5px 30px rgba(147, 51, 234, 1))' }}>
               Hello There
    ...
    borderImage: 'linear-gradient(to right, #FF5EFA ,#1C5CFF) 1'
                  ...
                  <div className=' flex lg:mt-12 mx-10 justify-center '>
